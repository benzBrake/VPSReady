...
ENCRYPTFLG=${BS_ENCRYPT_FLG:-false}
...
BACKUPPASS=${BS_ENCRYPT_PASSWORD:-mypassword}

# Directory to store backups
LOCALDIR="${BS_LOCAL_DIR:-/backups/}"

# Temporary directory used during backup creation
TEMPDIR="${BS_TEMP_DIR:-/backups/temp/}"
...
RCLONE_FLG="${BS_RCLONE_FLG:-false}"
